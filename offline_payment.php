...
<html>
<head>
    <title>VITC Inter MUN 2017 | Offline Payment</title>
    <meta charset="UTF-8">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12"><br>
                        ...
                        <p class="text-center">
                            <b>"Get ready with your suit, you have successfully registered yourself for VITCMUN 2017. However, the council and country will be alloted only after you pay the amount to our payment admins in the campus."</b>                
                        </p>
        ...
        <div class="container">
            ...
            <div id="contact" class="row">
                ...
                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                    ...
                    <ul>
                        <li class="opacity">
                            <span style="display:block;">The Debate Society VIT UNIVERSITY , Chennai Campus, Vandalur-Kelambakkam Road, Chennai, Tamil Nadu 600048</span>
                        </li>
