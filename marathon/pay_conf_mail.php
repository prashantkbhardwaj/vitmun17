...
$content .= "<header> ";
$content .= "<img src='http://vitcmun.com/marathon/img/vibrance_logo_dark.png' style='width: 180px;height: 60px;margin-right: 190px;'> ";
$content .= "<img src='http://vitcmun.com/marathon/img/vit_logo.png' style='width: 150px;height: 60px;'> ";
$content .= "</header> ";
