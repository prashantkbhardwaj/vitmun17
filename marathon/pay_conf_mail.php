...
$content .= "<header> ";
$content .= "<img src='http://35.154.143.210/marathon/img/vibrance_logo_dark.png' style='width: 180px;height: 60px;margin-right: 190px;'> ";
$content .= "<img src='http://35.154.143.210/marathon/img/vit_logo.png' style='width: 150px;height: 60px;'> ";
$content .= "</header> ";
